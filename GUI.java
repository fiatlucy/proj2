...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Settings->Move Limit", this::newLimit);
        addSeparator("Help");
        addMenuButton("Help->Tablut", this::newGen);
        addMenuButton("Help->About", this::newGen);
    ...
    /** Response to "Seed" button click. */
    private void newGen(String dummy) {
        String response =
                getTextInput("Type a question", "Helper",  "plain", "");
        if (response != null) {
            Matcher mat = SEED_PATN.matcher(response);
            if (mat.matches()) {
                _pendingCommands.offer("quit");
            } else {
                showMessage("Enter a question.", "Error", "error");
            }
        }
    }
